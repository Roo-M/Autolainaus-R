...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionTietoja_ohjelmasta.setVisible(True)
...
"color: rgb(255, 255, 255);")
        ...
        self.saveGroupPushButton.setGeometry(QRect(280, 40, 75, 25))
...
"color: rgb(255, 255, 255);")
        self.storedGroupsTableWidget = QTableWidget(self.groupTab)
        if (self.storedGroupsTableWidget.columnCount() < 2):
            self.storedGroupsTableWidget.setColumnCount(2)
        if (self.storedGroupsTableWidget.rowCount() < 10):
            self.storedGroupsTableWidget.setRowCount(10)
        self.storedGroupsTableWidget.setObjectName(u"storedGroupsTableWidget")
        self.storedGroupsTableWidget.setGeometry(QRect(10, 130, 241, 201))
        self.storedGroupsTableWidget.setFont(font2)
        self.storedGroupsTableWidget.setRowCount(10)
        self.storedGroupsTableWidget.setColumnCount(2)
        ...
        self.layoutWidget2.setGeometry(QRect(11, 11, 254, 56))
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.storedGroupsLabel.setText(QCoreApplication.translate("MainWindow", u"Tallennetut ryhm\u00e4t", None))
